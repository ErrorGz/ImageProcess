...
namespace Yolo5.NetCore.Models
{
    public class EmptyYoloModel : YoloModel
    {
        ...
        public override float Confidence { get; set; } = 0.2f;//对象置信度，原0.2
        public override float MulConfidence { get; set; } = 0.25f;//边框置信度，原0.25
        public override float Overlap { get; set; } = 0.75f;//重叠率，原0.45
