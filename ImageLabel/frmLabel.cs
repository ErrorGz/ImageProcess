...
namespace ImageLabel
{
    public partial class frmLabel : Form
    {
        ...
        List<YoloLabelModel> _listlabels;
        public BindingList<DoubleInt> listLabelId { get; set; }
        public BindingList<DoubleString> listLabelName { get; set; }


        public frmLabel(List<WorkSpaceClass> listworkspace, List<YoloLabelModel> listlabels)
        {
            InitializeComponent();
        ...
        private void frmLabelIds_Load(object sender, EventArgs e)
        {
            ...
            var listname = _listlabels.Select(o => new DoubleString { Name = o.Name, NewName = o.Name });
            listname.ForEach(o =>
            {
                listLabelName.Add(o);
        ...
        private void buttonApply_Click(object sender, EventArgs e)
        {
            ...
            {
                var label = _listlabels.Where(p => p.Name == o.Name).FirstOrDefault();
                if (label != null)
                    label.Name = o.NewName;
