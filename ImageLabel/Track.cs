...
namespace ImageLabel
{
    ...
    {
        public YoloPrediction Last_Prediction { get; set; }
        public YoloPrediction Current_Prediction { get; set; }
    ...
    public class Track
    {
        ...
        public void Update(double fs, List<YoloPrediction> prediction)
        {
